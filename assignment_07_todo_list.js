...
// Array is used to store all the tasks.
let tasks = [];


// This function is used for adding a new task to the to-do list.
function addTask() {
...
// This function is used for displaying all the tasks in the to-do list.
function viewTasks() {
    if (tasks.length === 0) {
...
// This function is used for deleting a task from the to-do list.
function deleteTask() {
    if (tasks.length === 0) {
        console.log("Your to-do list is empty.");
        return;
...
// This function is used for running the to-do list program until the user chooses to quit.
function main() {
    while (true) {
        showMenu();
